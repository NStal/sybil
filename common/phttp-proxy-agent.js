// Most of the above code are coppied from 
// https://github.com/TooTallNate/node-http-proxy-agent/blob/master/http-proxy-agent.js
// phttp is a private http proxy protocol that encrypts (ok base64) path
// to get rid of the big brother's deep package keyword detect
// thus and may change further without notification
...
//  }
  ...
  // also escape from deep package detect keyword like youtube.
    req._headers["host"] = this.proxy.host
