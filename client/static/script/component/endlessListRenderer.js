...
(function() {
  ...
  EndlessListRenderer = (function(_super) {
    ...
    EndlessListRenderer.prototype.adjustBufferList = function() {
      var afters, befores, between, bufferViewPort, end, endBetterBe, expandBottomFix, index, intersect, item, itemExpandFix, pack, shareEnd, shareStart, start, toRemove, viewPort, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4;
      this.unlockContainer();
  ...
  ResizeChecker = (function(_super) {
    ...
    ResizeChecker.prototype.stop = function() {
      ...
      this.isStart = false;
      return window.cancelAnimationFrame(this.checkTimer);
    };
    ...
    ResizeChecker.prototype.check = function() {
      ...
      return this.checkTimer = window.requestAnimationFrame((function(_this) {
        return function() {
          return _this.check();
        };
      })(this));
