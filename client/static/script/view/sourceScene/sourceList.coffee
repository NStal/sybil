...
CoreData = require "/module/coreData"
DragContext = require "/component/dragContext"
ContextMenu = require "/widget/contextMenu"
SmartImage = require "/widget/smartImage"
SourceAuthorizeTerminal = require "/view/sourceUtil/sourceAuthorizeTerminal"
Model = App.Model
...
tm.use "view/sourceScene/sourceList"
class SourceList extends Leaf.Widget
    constructor:()->
        super App.templates.view.sourceScene.sourceList
...
tm.use "view/sourceScene/sourceListItem"
class SourceListItem extends SourceListItemBase
    ...
    constructor:(@pack,@context)->
        @include SmartImage
        super App.templates.view.sourceScene.sourceListItem
        @source = @pack.model
...
tm.use "view/sourceScene/sourceListFolder"
class SourceListFolder extends SourceListItemBase
    ...
    constructor:(@pack,@context)->
        super App.templates.view.sourceScene.sourceListFolder
        @model = @pack.model
