...
(function() {
  var App, ContextMenu, CoreData, DragContext, Model, SmartImage, SourceAuthorizeTerminal, SourceList, SourceListDragController, SourceListFolder, SourceListItem, SourceListItemBase, SourceListManager, tm,
  ...
  SourceList = (function(_super) {
    ...
    function SourceList() {
      SourceList.__super__.constructor.call(this, App.templates.view.sourceScene.sourceList);
  ...
  SourceListItem = (function(_super) {
    ...
    function SourceListItem(pack, context) {
      ...
      SourceListItem.__super__.constructor.call(this, App.templates.view.sourceScene.sourceListItem);
    ...
    SourceListItem.prototype.showSourceDetail = function() {
      App.sourceScene.sourceDetail.setSource(this.source);
      return App.sourceScene.sourceDetail.show();
    };
  ...
  SourceListFolder = (function(_super) {
    ...
    function SourceListFolder(pack, context) {
      this.pack = pack;
      this.context = context;
      SourceListFolder.__super__.constructor.call(this, App.templates.view.sourceScene.sourceListFolder);
