...
class ListScene extends Scene
    constructor:()->
        ...
        super App.templates.view.listScene.scene,"list scene"
#        @list.appendTo @node
...
class List extends Leaf.Widget
    constructor:(@context)->
        super App.templates.view.listScene.listSceneList
...
class ListItem extends Leaf.Widget
    constructor:(@archiveList)->
        super App.templates.view.listScene.listSceneListItem
...
class ArchiveList extends Leaf.Widget
    constructor:(@context)->
        ...
        super App.templates.view.listScene.listSceneArchiveList
...
class ArchiveListItem extends Leaf.Widget
    constructor:(@archive)->
        super App.templates.view.listScene.listSceneArchiveListItem
        @render()
        @isDone = false
...
class ListArchiveDisplayer extends ArchiveDisplayer
    constructor:(@context)->
        ...
        super App.templates.view.listScene.archiveDisplayer
...
class ArchiveHelper extends Leaf.Widget
    constructor:(@archiveDisplayer)->
        super App.templates.view.listScene.archiveHelper
