...
(function() {
  var App, ContextMenu, ContextMenuItem, Mask, tm,
  ...
  ContextMenu = (function(_super) {
    ...
    function ContextMenu(selections) {
      ...
      ContextMenu.__super__.constructor.call(this, App.templates.widget.contextMenu);
  ...
  ContextMenuItem = (function(_super) {
    ...
    function ContextMenuItem(word) {
      ContextMenuItem.__super__.constructor.call(this, App.templates.widget.contextMenuItem);
      this.node$.text(word);
    }
