...
(function() {
  var ContextMenu, CoreData, DragContext, Model, SmartImage, SourceList, SourceListDragController, SourceListFolder, SourceListItem, SourceListItemBase, SourceListManager, tm,
  ...
  SourceList = (function(_super) {
    ...
    SourceList.prototype.reflow = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        item.node$.css({
          top: item.pack.position * this.itemHeight,
