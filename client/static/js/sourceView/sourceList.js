...
(function() {
  var App, ContextMenu, DragContext, Model, SmartImage, SourceAuthorizeTerminal, SourceList, SourceListDragController, SourceListFolder, SourceListFolderContextMenu, SourceListInitializer, SourceListItem, SourceListItemBase, SourceListItemContextMenu, SourceListSyncManager, async, tm,
  ...
  SourceListItem = (function(_super) {
    ...
    function SourceListItem(source) {
      ...
      this.source = source;
      this.UI.sourceIcon.on("state", function(state) {
        if (state === "success") {
          return this.UI.sourceIcon.style.display = "inline";
        }
      });
