//***************************************************************************
// Custom Modifications should prefix with comment like // CUSTOM:
// Modified by NStal
//
//
//*******************************************8
            ...
            for (var i = 0; i < attribs.length; i += 2) {
                ...
                if (atype !== null) {
                    ...
                    case html4.atype.STYLE:
                        // CUSTOM:  allow style attribute via value = value
                        //value = value;
		        ...
		        //modified for retain URI
                        value = value;//opt_uriPolicy && opt_uriPolicy(value);
                        break;
...
html4 .ATTRIBS = {
    ...
    'img::alt': 0,
    'img::border': 0,
    'img::height': 2, // CUSTOM originally 0 make it 2 so filtered
    'img::data-raw-src':0,  // CUSTOM properties
    'img::data-medium-src':0,  // CUSTOM properties
    'img::data-thumbnail-src':0,  // CUSTOM properties
    'img::hspace': 0,
    'img::ismap': 0,
    'img::name': 7,
    'img::src': 1,
    'img::usemap': 11,
    'img::vspace': 0,
    'img::width': 2, // CUSTOM originally 0 make it 2 so filtered
    'input::accept': 0,
    'input::accesskey': 0,
    'input::align': 0,
    'input::alt': 0,
