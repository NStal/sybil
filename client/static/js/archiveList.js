...
(function() {
  var App, ArchiveList, ArchiveListController, ArchiveListItem, CubeLoadingHint, EndlessArchiveLoader, Model, ScrollChecker, async,
  ...
  ArchiveListController = (function(_super) {
    ...
    ArchiveListController.prototype.onClickPrevious = function() {
      ...
      return console.debug("click? previous");
    };
    ...
    ArchiveListController.prototype.onClickNext = function() {
      ...
      return console.debug("click next?");
    };
    ...
    ArchiveListController.prototype.isLast = function(item) {
      return this.archiveList.archiveListItems[this.archiveList.archiveListItems - 1] === item;
    };
