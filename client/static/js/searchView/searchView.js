...
(function() {
  var App, ArchiveDisplayer, CubeLoadingHint, EndlessSearchArchiveLoader, Model, SearchList, SearchListItem, SearchView, SwipeChecker, View, async, tm,
  ...
  SearchList = (function(_super) {
    ...
    function SearchList() {
      ...
      SearchList.__super__.constructor.call(this, App.templates.searchView.searchList);
  ...
  SearchListItem = (function(_super) {
    ...
    function SearchListItem(archive) {
      ...
      SearchListItem.__super__.constructor.call(this, App.templates.searchListItem);
