...
(function() {
  var App, ContextMenu, DragContext, Model, SourceList, SourceListDragController, SourceListFolder, SourceListFolderContextMenu, SourceListInitializer, SourceListItem, SourceListItemBase, SourceListItemContextMenu, SourceListSyncManager, async,
  ...
  SourceListItem = (function(_super) {
    ...
    SourceListItem.prototype.destroy = function() {
      this.emit("remove");
      return SourceListItem.__super__.destroy.call(this);
    };
      ...
      _save = (function(_this) {
        return function() {
          ...
          if (Leaf.Util.compare(folders, _this.currentFolderData)) {
            ...
            console.debug(folders, _this.currentFolderData, "~~");
            return;
          }
