...
(function() {
  var App, ArchiveDisplayer, EndlessSearchArchiveLoader, Model, SearchList, SearchListItem, SearchView, SwipeChecker, View, async,
  ...
  SearchList = (function(_super) {
    ...
    function SearchList() {
      ...
      this.resultList.on("child/remove", (function(_this) {
