...
(function() {
  ...
  Source = (function(_super) {
    ...
    Source.prototype.fields = ["name", "guid", "unreadCount", "tags", "uri", "collectorName", "description", "totalArchive", "statistic", "type", "lastError", "lastErrorDescription", "requireLocalAuth", "requirePinCode", "lastUpdate", "lastFetch", "nextFetchInterval"];
