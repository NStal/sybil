...
(function() {
  var App, ArchiveDisplayer, ArchiveHelper, ArchiveList, ArchiveListItem, ContextMenu, CubeLoadingHint, Flag, List, ListArchiveDisplayer, ListItem, ListView, Model, ScrollChecker, SwipeChecker, View, moment, tm,
  ...
  ListArchiveDisplayer = (function(_super) {
    ...
    function ListArchiveDisplayer(context) {
      ...
      ListArchiveDisplayer.__super__.constructor.call(this, App.templates.listView.archiveDisplayer);
  ...
  ArchiveHelper = (function(_super) {
    ...
    function ArchiveHelper(archiveDisplayer) {
      ...
      ArchiveHelper.__super__.constructor.call(this, App.templates.listView.archiveHelper);
