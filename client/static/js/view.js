...
(function() {
  var View, ViewSelectItem, ViewSwitcher,
  ...
  ViewSwitcher = (function(_super) {
    ...
    ViewSwitcher.prototype.onClickTitle = function() {
      this.syncViews();
      if (this.isShow) {
        return this.hide();
      } else {
    ...
    ViewSwitcher.prototype.show = function() {
      this.isShow = true;
      this.UI.viewSelector$.slideDown(100);
    ...
    ViewSwitcher.prototype.hide = function() {
      this.isShow = false;
      this.UI.viewSelector$.slideUp(100);
  ...
  ViewSelectItem = (function(_super) {
    ...
    ViewSelectItem.prototype.onClickNode = function() {
