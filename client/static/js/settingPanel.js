...
(function() {
  var IntEntry, SettingEntry, SettingGroup, SettingPanel, StringEntry,
  ...
  SettingPanel = (function(_super) {
    ...
    SettingPanel.prototype.syncBySettingOptions = function(options) {
      var group, _results;
